...
const DeveloperCard: React.FC<DeveloperCardProps> = ({ developer }) => (
  <Card className="mb-4">
    ...
    <CardContent>
      ...
      <SkillScore label="Technical Skills" score={developer.skills.technical} />
      ...
      />
      <SkillScore label="Availability" score={developer.skills.availability} />
    </CardContent>
  </Card>
);
...
export default function Page() {
  ...
  const projectDataXD = api.clients.getById.useQuery({ id: Number(projectId) });
